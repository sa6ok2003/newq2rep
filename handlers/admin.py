...
@dp.message_handler(commands=['stat']) #Статистика партнеров
async def partner_ka(message: types.Message):
    if message.chat.id == PARTNERS1: #АЛЕКСЕЙ
        print('12321212')
